...
export declare class PassengerService {
    ...
    constructor(passengerRepository: Repository<Passenger>, ticketRepository: Repository<Ticket>, jwtService: JwtService, emailService: EmailService, scheduleService: ScheduleService);
    ...
    createMultipleTickets(passengerId: number, createMultipleTicketsDto: CreateMultipleTicketsDto): Promise<Ticket[]>;
    getPassengerTickets(passengerId: number): Promise<Ticket[]>;
    getPassengerTicketsGrouped(passengerId: number): Promise<any>;
    cancelBookingGroup(passengerId: number, bookingGroupId: string): Promise<Ticket[]>;
