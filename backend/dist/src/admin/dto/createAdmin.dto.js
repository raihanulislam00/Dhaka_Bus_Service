...
__decorate([
    ...
    (0, class_validator_1.MaxLength)(150, { message: 'Unique ID must not exceed 150 characters' }),
    (0, class_validator_1.IsUUID)('4', { message: 'uniqueId cannot be same' }),
    __metadata("design:type", String)
], CreateAdminDto.prototype, "uniqueId", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
