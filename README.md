...
*The main landing page with navigation and overview of services*

#### About Page
![About Page](./screenshots/about-page.png)
*Information about the Dhaka Bus Service and company details*
...
![Passenger Registration](./screenshots/passenger-register.png)
*User-friendly registration form for new passengers*

#### Passenger Login
![Passenger Login](./screenshots/passenger-login.png)
*Secure login interface for passengers*

#### Passenger Dashboard
![Passenger Dashboard](./screenshots/passenger-dashboard.png)
*Comprehensive dashboard showing booking history and quick actions*

#### Ticket Booking
![Ticket Booking](./screenshots/ticket-booking.png)
*Intuitive ticket booking interface with route selection*

### 🚗 Driver Portal

#### Driver Registration
![Driver Registration](./screenshots/driver-register.png)
*Professional driver registration with document upload*

#### Driver Login
![Driver Login](./screenshots/driver-login.png)
*Secure authentication for drivers*

#### Driver Dashboard
![Driver Dashboard](./screenshots/driver-dashboard.png)
*Driver dashboard with route assignments and trip status*

#### Driver Routes
![Driver Routes](./screenshots/driver-routes.png)
*Assigned routes and navigation information*

#### Driver Schedules
![Driver Schedules](./screenshots/driver-schedules.png)
*Daily and weekly schedule management*

#### Trip Management
![Trip Management](./screenshots/driver-trips.png)
*Active trip monitoring and status updates*
...
#### Manage Drivers
![Manage Drivers](./screenshots/admin-manage-drivers.png)
*Driver approval, monitoring, and management interface*

#### Manage Passengers
![Manage Passengers](./screenshots/admin-manage-passengers.png)
*Passenger account management and monitoring*

#### Route Management
![Route Management](./screenshots/admin-routes.png)
*Create, edit, and manage bus routes*

#### Schedule Management
![Schedule Management](./screenshots/admin-schedules.png)
*Configure and manage bus schedules*

### 🗺️ Interactive Features

#### Bus Tracking Demo
![Bus Tracking](./screenshots/bus-tracking-demo.png)
